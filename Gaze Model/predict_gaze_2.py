...
import sys
sys.path.append('/home/sameera/Downloads/caffe-master/python')
import caffe
...
class Gaze():
    ...
    def prepImages(self, img, e):
        ...
        places_mean = sio.loadmat('/home/sameera/Documents/DevRob/model/places_mean_resize.mat')
        imagenet_mean = sio.loadmat('/home/sameera/Documents/DevRob/model/imagenet_mean_resize.mat')
...
if __name__ == '__main__':
    model_def = '/home/sameera/Documents/DevRob/model/deploy_demo.prototxt'
    model_weights = '/home/sameera/Documents/DevRob/model/binary_w.caffemodel'
