    ...
    while time_taken<20:
        ...
        if getBall is not None:
            if getBall[0] > 0.0 and getBall[1] > 0.0:
                ...
                print 'ball Pos. X ({}) Y ({})'.format(center_ball_x, center_ball_y)
...
1. logic of the code and how the information flows: think about a UML diagram or some other kind of flowchart, that indicates classes in your program, or script names.
the dependencies of your system ie. windows, python3, something else version XX, library Z, etc.
2. make sure the code is readable, so if i want to use this in the future I have all the information that I need. so i should be able to read it without too much effort,
document what functions do, and document what variables represent
